...
export const NEW_APPOINTMENT_EMAIL_TEMPLATE = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
  <p>Hello,</p>
  <p>A new appointment has been scheduled with {patientName}.</p>
...
export const UPDATE_APPOINTMENT_EMAIL_TEMPLATE = `
  <!DOCTYPE html>
  <html lang="en">
  <head>
  <meta charset="UTF-8">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
  <p>Hello,</p>
  <p>An appointment update has been made with {patientName}.</p>
  <p>Appointment Details:</p>
  <p>{doctorName}</p>
  <p>Date: {appointmentDate}</p>
  <p>Time: {appointmentTime}</p>
